...
**URL Base:** `https://projetoiotskillbridge.onrender.com`

**Status:** ✅ **Deploy realizado no Render**

**Documentação Swagger:** `https://projetoiotskillbridge.onrender.com/docs`

**Health Check:** `https://projetoiotskillbridge.onrender.com/health`

**Rota Raiz:** `https://projetoiotskillbridge.onrender.com/`
...
#### Verificar se está online:
```bash
curl https://projetoiotskillbridge.onrender.com/health
```
...
#### Acessar Swagger UI:
1. Abra no navegador: `https://projetoiotskillbridge.onrender.com/docs`
2. Teste o endpoint `/gerar-plano-estudos`

#### Gerar plano de estudos:
```bash
curl -X POST https://projetoiotskillbridge.onrender.com/gerar-plano-estudos \
  -H "Content-Type: application/json" \
  -d '{
...
IOT_SERVICE_URL=https://projetoiotskillbridge.onrender.com
PORT=8080
```
...
- ✅ **Serviço IoT:** Deploy realizado no Render
